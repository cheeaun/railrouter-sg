var SVY21 = (function(){
    ...
    // WGS84 Datum
    this.a = 6378137.0;
    this.f = 0.00335281066474746; // 1 / 298.257223563;
    ...
    this.oLat = 1.36666666666667;     // origin's lat in degrees
    this.oLon = 103.833333333333;   // origin's lon in degrees
    this.oN = 38744.572;      // false Northing
		this.oE = 28001.642;      // false Easting
    this.k = 1.0;               // scale factor
...
module.exports = function(Y, X){
  var result = cv.computeLatLon(Y, X);
